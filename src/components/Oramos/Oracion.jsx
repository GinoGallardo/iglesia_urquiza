...
export default function Oracion() {
  return (
    ...
    >
      ...
      <h4 className='text-center text-red-600 font-bold font-serif text-2xl md:text-3xl lg:text-4xl'>Oramos por Vos</h4>
      ...
      <a 
        href="https://api.whatsapp.com/send?phone=01121697373"
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center md:gap-4 bg-red-600 py-2 px-4 rounded-md cursor-pointer hover:bg-red-400 text-2xl font-semibold"
      >
