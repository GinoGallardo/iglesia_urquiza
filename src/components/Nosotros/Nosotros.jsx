...
function Nosotros() {
  return (
    <section className="flex flex-col p-2 gap-y-8 md:p-6 md:my-10">
      <h2 className="text-center text-red-600 font-bold font-serif sm:text-2xl md:text-3xl lg:text-4xl">Sobre nosotros</h2>
      <div className="grid grid-cols-4 gap-4 p-6 mx-auto md:grid-cols-4 lg:w-7xl lg:grid-cols-6">
        ...
        <div className="grid gap-2 col-span-4 md:col-span-2 md:gap-4 lg:col-span-4">
            <h2 className="text-center text-2xl font-serif font-extrabold md:text-wrap md:text-4xl lg:text-6xl">Llevamos el evangelio, vivimos el propósito</h2>
          ...
          <div className="grid grid-cols-1 md:mt-4 md:gap-y-4">
